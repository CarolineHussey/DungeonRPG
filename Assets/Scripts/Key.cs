...
public class Key : Collectable
{
    ...
    protected override void OnCollect()
    {
        ...
        if (!collected)
        {
            ...
            GameManager.instance.ShowText("+ " + KeyManager.instance.keysCollected + " key collected", 30, Color.cyan, transform.position, Vector3.up * 25, 1.5f);
            Destroy(gameObject);
        ...
        if (KeyManager.instance.keysCollected >= KeyManager.instance.numberOfKeys)
        {
            ...
            GameManager.instance.ShowText("A new portal has opened!", 30, Color.green, transform.position + Vector3.down, Vector3.zero, 1.5f);
